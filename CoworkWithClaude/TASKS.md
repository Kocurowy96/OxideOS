...
- [ ] Klawiatura (`kernel/drivers/ps2_kbd.cpp`) nie obsługuje Shift/Caps Lock — tylko małe litery, żadnych `!@#$%` itd. Dotyczy każdej apki z wpisywaniem tekstu, nie tylko Notatnika. Znalezione 2026-09-20.
